...
style: |
  ...
  .attr .k { font-size: 0.5em; color: var(--gray); text-transform: uppercase; letter-spacing: 0.1em; margin-bottom: 2px; }
  .attr .v { font-size: 0.62em; font-weight: 600; color: var(--navy); }
...
<div class="inner">
  ...
  <p style="font-size:0.72em; color:var(--gray); margin-bottom:0">Dataset exploration, research context, graph structure, building selection, and first results from graph analysis on the Narkomfin Building.</p>
  ...
  <div class="contents-list">
    <div class="contents-item">
      ...
      <div>
        ...
        <div class="contents-desc">Modified Swiss Dwellings: 5,372 residential floor plans as graphs</div>
      </div>
    </div>
    <div class="contents-item">
    ...
    <div class="contents-item">
      ...
      <div>
        <div class="contents-title">Pipeline</div>
        <div class="contents-desc">Floor plan design → graph construction & analysis → node classification</div>
      </div>
    </div>
    <div class="contents-item">
      <div class="contents-num">05</div>
      <div>
        <div class="contents-title">The Narkomfin Building</div>
        <div class="contents-desc">Building introduction · spatial concept · why it maps to graph ML</div>
      </div>
    </div>
    <div class="contents-item">
      <div class="contents-num">06</div>
      <div>
        <div class="contents-title">Graph Analysis: Plan 1</div>
        <div class="contents-desc">Closeness centrality · betweenness centrality · shortest path</div>
      </div>
    </div>
  </div>
</div>
...
<div class="inner">
  ...
  <div class="steps" style="margin-top:8px;">
    <div class="step">
      <div class="n">01</div>
      <div>
        <div class="t">Floor Plan Input</div>
        <div class="d">Use the F-type and K-type floor plans from the Narkomfin Building as our input geometry, redrawn in Rhino as closed polylines with shared edges for TopologicPy adjacency detection.</div>
      </div>
    </div>
    <div class="step">
      <div class="n">02</div>
      <div>
        ...
        <div class="d">Convert OBJ geometry to a face BREP, then compute closeness centrality, betweenness centrality, and shortest path across the floor plan.</div>
      </div>
    </div>
    <div class="step">
      <div class="n">03</div>
      <div>
        ...
        <div class="d">Label nodes with <code>zoning_type</code> and edges as door/entrance, export graph CSVs, then run the pretrained model to predict <code>room_type</code>.</div>
      </div>
    </div>
  </div>
</div>
...
<div class="sidebar"><span class="seminar">Digital tools for<br>Graph Machine Learning</span><span class="assignment">Final Assignment - G02</span></div>
<div class="inner">
  <div class="sec-hdr"><div class="section-num">05</div><div class="section-sub">Our Building</div></div>
  <h1>The Narkomfin Building</h1>
  <hr>

  <div class="cols" style="flex:1; min-height:0; gap:20px;">
    <div class="col" style="flex:1.3">
      <div class="img-frame" style="height:210px; background:#111; border-radius:4px; overflow:hidden;">
        <img src="img/narkomfin.jpg" style="width:100%; height:100%; object-fit:cover; object-position:center;">
      </div>
      <div class="img-cap" style="margin-top:5px">Post-restoration render · Ginsburg Architects · Moscow, 2021</div>
    </div>
    <div class="col">
      <div class="attr-bar" style="flex-direction:column; gap:1px; margin:0 0 12px;">
        <div class="attr"><div class="k">Architects</div><div class="v">Moisei Ginzburg &amp; Ignaty Milinis</div></div>
        <div class="attr"><div class="k">Year / Location</div><div class="v">1930 · Moscow, Russia</div></div>
        <div class="attr"><div class="k">Typology</div><div class="v">Collective housing, dom-kommuna</div></div>
        <div class="attr"><div class="k">Scale</div><div class="v">54 apartments · 6 floors</div></div>
        <div class="attr"><div class="k">Unit types</div><div class="v rust">F-type duplex · K-type communal</div></div>
      </div>
      <p style="font-size:0.72em; margin:0 0 6px">A landmark of Soviet Constructivism, designed as a <strong>social condenser</strong>: private space minimised, shared infrastructure maximised.</p>
      <p style="font-size:0.72em; margin:0">Two distinct floor plan typologies and a clear spatial hierarchy make it an ideal subject for graph-based analysis.</p>
    </div>
  </div>
</div>
...
<div class="inner">
  ...
  <div class="cols" style="flex:1; min-height:0;">
    <div class="col">
      <div class="card">
        <div class="tag">Spatial Concept</div>
        <div class="ttl">The Social Condenser</div>
        <ul>
          <li>Private cells minimal: sleep and work only</li>
          <li>Shared corridor spine: the sole circulation artery</li>
          <li>Communal programme in a separate linked block</li>
          <li>Legible spatial hierarchy, ideal for graph analysis</li>
        </ul>
      </div>
    </div>
    <div class="col">
      <div class="card">
        <div class="tag">Why it fits graph ML</div>
        <div class="ttl">Clear Zoning · Two Plan Types</div>
        <ul>
          <li>Corridor → <strong>Dynamic (1)</strong>, unambiguous node label</li>
          <li>Cells → <strong>Static (2)</strong>, communal → <strong>Living (0)</strong> + <strong>Functional (3)</strong></li>
          <li>F-type &amp; K-type units: two spatial configurations to compare</li>
          <li>Orthogonal geometry → clean TopologicPy graph construction</li>
        </ul>
      </div>
    </div>
  </div>
  ...
  <div class="chips" style="margin-top:10px">
    <span class="chip rust">Soviet Constructivism · 1930</span>
    <span class="chip">Social condenser</span>
    <span class="chip">Linear spine</span>
    <span class="chip">F-type duplex</span>
    <span class="chip">K-type communal</span>
    <span class="chip">Modular repetition</span>
  </div>
</div>
...
<div class="sidebar"><span class="seminar">Digital tools for<br>Graph Machine Learning</span><span class="assignment">Final Assignment - G02</span></div>
<div class="inner">
  <div class="sec-hdr"><div class="section-num">06</div><div class="section-sub">Graph Analysis</div></div>
  <h1>Plan 1 — Closeness Centrality</h1>
  <hr>

  <div class="img-frame" style="height:330px; background:#000; border-radius:4px; margin-bottom:6px;">
    <img src="img/plan1-closeness-centrality.png" style="width:100%; height:100%; object-fit:contain;">
  </div>
  <div class="img-cap" style="margin-bottom:8px">Thermal scale — warm = high integration, cool = low integration</div>

  <p style="font-size:0.65em; line-height:1.55;">The <strong>corridor scores highest</strong> — every room is reachable from it in the <strong>fewest steps</strong>. Closeness drops into the <strong>private cells</strong>, and the staircase block scores <strong>lowest</strong> as a dead-end terminal. The gradient confirms the corridor as the <strong>social and circulatory core</strong> of the plan.</p>
</div>
...
<div class="inner">
  <div class="sec-hdr"><div class="section-num">06</div><div class="section-sub">Graph Analysis</div></div>
  <h1>Plan 1 — Betweenness Centrality</h1>
  <hr>

  <div class="img-frame" style="height:330px; background:#000; border-radius:4px; margin-bottom:6px;">
    <img src="img/plan1-betweenness-centrality.png" style="width:100%; height:100%; object-fit:contain;">
  </div>
  <div class="img-cap" style="margin-bottom:8px">Thermal scale — warm = high traffic, cool = low traffic</div>

  <p style="font-size:0.65em; line-height:1.55;"><strong>Central corridor sections score highest</strong> — every cross-building journey passes through them. End rooms have <strong>near-zero betweenness</strong>; they are <strong>destinations, not conduits</strong>. The corridor serves as both the <strong>most accessible and most traversed spine</strong> of the plan.</p>
</div>
...
<div class="inner">
  <div class="sec-hdr"><div class="section-num">06</div><div class="section-sub">Graph Analysis</div></div>
  <h1>Plan 1 — Shortest Path</h1>
  <hr>

  <div class="img-frame" style="height:330px; background:#000; border-radius:4px; margin-bottom:6px;">
    <img src="img/plan1-shortest-path.png" style="width:100%; height:100%; object-fit:contain;">
  </div>
  <div class="img-cap" style="margin-bottom:8px">Grid path (red, 77.2 units) vs straightened path (blue, 74.4 units)</div>

  <p style="font-size:0.65em; line-height:1.55;">The grid path (red, 77.2) and straightened path (blue, 74.4) are <strong>nearly identical</strong> — only <strong>3.7% shorter</strong> when straightened. The corridor is already the straight line, leaving <strong>little room for a shortcut</strong>. The <strong>most efficient route</strong> and the <strong>only social route</strong> are the same.</p>
</div>
